...
suppressWarnings(do.call(grid.arrange, histos[2:13]))
suppressWarnings(do.call(grid.arrange, histos[14:25]))
suppressWarnings(do.call(grid.arrange, histos[26:37]))
suppressWarnings(do.call(grid.arrange, histos[38:49]))
suppressWarnings(do.call(grid.arrange, histos[50:60]))
