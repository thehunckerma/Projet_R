...
messages=unlist(lapply(names(c(map1[1],map1[3:length(map1)])),function(x){
   p_value=wilcox.exact(unlist(men[x]),unlist(women[x]),paired=FALSE)$p.value
...
ggsave("img/twoSamples1.png",do.call(grid.arrange, twoSamples[1:12]))
ggsave("img/twoSamples2.png",do.call(grid.arrange, twoSamples[13:24]))
ggsave("img/twoSamples3.png",do.call(grid.arrange, twoSamples[25:36]))
ggsave("img/twoSamples4.png",do.call(grid.arrange, twoSamples[37:48]))
ggsave("img/twoSamples5.png",do.call(grid.arrange, twoSamples[49:60]))
